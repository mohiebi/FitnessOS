        ...
        <div className="min-h-screen bg-background">
            ...
            <section className="mx-auto max-w-4xl px-6 py-24">
                ...
                <p className="mt-6 text-lg text-muted-foreground">
                    FitnessOS was born inside a real coaching business. After
                    years of gluing together spreadsheets, Notion pages,
                    Telegram groups and 4 separate SaaS tools, we built the
                    platform we always wished existed.
                </p>
                <img
                    src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=1600&auto=format&fit=crop"
                    className="mt-10 aspect-[16/9] w-full rounded-2xl object-cover shadow-card-premium"
                    alt="Team"
                />
                ...
                <div className="mt-16 grid gap-6 md:grid-cols-3">
                    {[
                        {
                            t: 'Coach-first',
                            d: 'Every feature ships only after 20+ working coaches use it in production.',
                        },
                        {
                            t: 'Design matters',
                            d: "Your clients will actually open the app. That's half the battle.",
                        },
                        {
                            t: 'AI where it helps',
                            d: 'We use AI to remove admin — not to replace the human coach.',
                        },
                    ].map((v) => (
                        <Card
                            key={v.t}
                ...
                <div className="mt-20 rounded-2xl border border-border/60 bg-card p-10 text-center">
                    ...
                    <p className="mt-2 text-muted-foreground">
                        Tour the coach dashboard and client app.
                    </p>
                    <div className="mt-6 flex justify-center gap-3">
                        ...
                        >
                            <Link to="/apply">Apply for coaching</Link>
                        </Button>
                    </div>
                </div>
            </section>
