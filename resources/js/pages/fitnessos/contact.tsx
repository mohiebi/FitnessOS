          ...
          <Card className="border-border/60 bg-card p-8 shadow-card-premium">
            <form className="space-y-5">
              <div className="grid gap-4 sm:grid-cols-2">
                <div><Label className="mb-2 block">First name</Label><Input placeholder="Sarah" /></div>
                <div><Label className="mb-2 block">Last name</Label><Input placeholder="Chen" /></div>
              </div>
              <div><Label className="mb-2 block">Email</Label><Input type="email" placeholder="you@email.com" /></div>
              <div><Label className="mb-2 block">Message</Label><Textarea rows={5} placeholder="How can we help?" /></div>
              <Button type="button" className="w-full rounded-full bg-brand-gradient text-primary-foreground">Send message</Button>
            </form>
          </Card>
        </div>
      </section>
