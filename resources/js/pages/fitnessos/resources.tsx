                ...
                <div className="mt-6 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    {tools.map((t) => {
                        ...
                        return (
                            <Card
                                key={t.title}
                                className="group cursor-pointer border-border/60 bg-card p-6 shadow-card-premium transition-all hover:-translate-y-1 hover:border-primary/40 hover:shadow-glow"
                            >
                                ...
                                <div className="mt-4 flex items-center gap-1 text-sm text-primary opacity-0 transition group-hover:opacity-100">
