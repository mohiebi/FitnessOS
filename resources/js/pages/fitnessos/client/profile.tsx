            ...
            <div className="grid gap-6 md:grid-cols-3">
                <Card className="border-border/60 bg-card p-6 text-center shadow-card-premium">
                    <Avatar className="mx-auto h-24 w-24">
                        <AvatarImage src="https://i.pravatar.cc/240?img=47" />
                    ...
                    <Badge className="mt-3 bg-primary/15 text-primary">
                        Elite · 12 wk
                    </Badge>
                    <div className="mt-6 grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <div className="text-lg font-semibold">47d</div>
                        </div>
                    </div>
                </Card>
                ...
                <Card className="border-border/60 bg-card p-6 shadow-card-premium md:col-span-2">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        {[
                            ...
                            <div key={k}>
                                <Label className="mb-2 block">{k}</Label>
