    ...
    return (
        <div>
            <PageHeader
                ...
                description="Takes 5 minutes. Coach will reply within 24h."
            />
            ...
            <div className="grid gap-6 lg:grid-cols-2">
                <Card className="border-border/60 bg-card p-6 shadow-card-premium">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div>
                            <Label className="mb-2 block">Sleep avg (h)</Label>
                            <Input defaultValue="7.8" />
                        </div>
                        <div>
                            <Label className="mb-2 block">Steps avg</Label>
                            <Input defaultValue="9,400" />
                        </div>
                    </div>
                    <div className="mt-6">
                        <Label className="mb-2 block">Energy · 8/10</Label>
                        <Slider defaultValue={[8]} max={10} step={1} />
                    </div>
                    <div className="mt-6">
                        <Label className="mb-2 block">Hunger · 4/10</Label>
                ...
                <Card className="border-border/60 bg-card p-6 shadow-card-premium">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {[1, 2, 3].map((i) => (
                            <div
                                key={i}
                                className="grid aspect-[3/4] cursor-pointer place-items-center rounded-xl border-2 border-dashed border-border/60 text-muted-foreground transition hover:border-primary hover:text-primary"
                            >
                ...
                <Card className="border-border/60 bg-card p-6 shadow-card-premium lg:col-span-2">
                    ...
                    <Textarea
                        rows={3}
                        placeholder="Optional — energy, workouts, meals, life…"
                    />
