            ...
            <section className="bg-hero-gradient">
                <div className="mx-auto max-w-4xl px-6 py-24 text-center">
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
                        Choose the path that fits — 1:1 personal coaching,
                        high-touch nutrition, or a proven group cohort.
                    </p>
                </div>
            </section>
            ...
            <section className="mx-auto max-w-7xl px-6 pb-24">
                <Card className="border-primary/30 bg-hero-gradient p-12 text-center shadow-glow">
                    ...
                    <p className="mt-2 text-muted-foreground">
                        We only take on 20 new clients per month.
                    </p>
                    <Button
                        asChild
                        size="lg"
                        className="mt-6 rounded-full bg-brand-gradient text-primary-foreground"
                    >
                        <Link to="/apply">
                            Start application{' '}
