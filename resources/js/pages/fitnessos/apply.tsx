...
import {
    RadioGroup,
    RadioGroupItem,
} from '@/fitnessos/components/ui/radio-group';
            ...
            <div className="min-h-screen bg-background">
                ...
                <section className="mx-auto max-w-2xl px-6 py-24 text-center">
                    ...
                    <p className="mt-3 text-muted-foreground">
                        We'll review and reply within 24 hours. Check your
                        email.
                    </p>
                </section>
                <Footer />
                    ...
                    {step === 1 && (
                        <div className="space-y-5">
                            <Field label="Primary goal">
                                ...
                                >
                                    {[
                                        ...
                                        <label
                                            key={g}
                                            className="flex cursor-pointer items-center gap-2 rounded-xl border border-border/60 bg-card p-3 hover:border-primary/40"
                                        >
                                            <RadioGroupItem
                                                value={g.toLowerCase()}
                                            />
                            ...
                            <Field label="Target timeline">
                                <Input placeholder="e.g. 12 weeks before a wedding" />
                            </Field>
                            <Field label="What would success look like?">
                                <Textarea
                                    rows={4}
                                    placeholder="Describe what winning looks like for you."
                                />
                            </Field>
                        </div>
                    )}
                    {step === 2 && (
                        <div className="space-y-5">
                            ...
                            <Field label="Injuries or limitations">
                                <Textarea
                                    rows={3}
                                    placeholder="Any injuries or restrictions we should know about?"
                                />
                            </Field>
                        </div>
                    )}
                                    ...
                                    {[
                                        {
                                            ...
                                            n: 'Starter',
                                            p: '$99/mo',
                                            d: '8-week starter program',
                                        },
                                        {
                                            v: 'pro',
                                            n: 'Pro',
                                            p: '$199/mo',
                                            d: '12-week 1:1 coaching',
                                        },
                                        {
                                            v: 'elite',
                                            n: 'Elite',
                                            p: '$399/mo',
                                            d: '24-week premium coaching',
                                        },
                                    ].map((p) => (
                                        <label
                                            key={p.v}
                                            className="flex cursor-pointer items-center gap-3 rounded-xl border border-border/60 bg-card p-4 hover:border-primary/40"
                                        >
                    ...
                    {step === 4 && (
                        <div className="space-y-4 text-sm">
                            <div className="rounded-xl bg-primary/10 p-4 text-primary">
                                Application ready to submit — we'll reply within
                                24h.
                            </div>
                            <p className="text-muted-foreground">
                                Please confirm your details are correct on the
                                previous steps. By submitting you agree to our
                                terms.
                            </p>
                        </div>
                    )}
