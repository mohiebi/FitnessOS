        ...
        <div>
            ...
            <Card className="mb-6 border-primary/30 bg-primary/5 p-6 shadow-glow">
                ...
                <p className="mt-3 text-sm text-muted-foreground">
                    Sarah is down 0.7kg this week (-7.0kg total) with 94%
                    adherence. Sleep improved to 7.8h avg and energy is trending
                    up. Deadlift PR at 160kg. Recommend: hold calories, add 5kg
                    to compound lifts, celebrate the win.
                </p>
            </Card>
            ...
            <div className="mt-6 grid gap-6 lg:grid-cols-2">
                ...
                <Card className="border-border/60 bg-card p-6 shadow-card-premium">
                    ...
                    <Textarea
                        rows={6}
                        defaultValue="Sarah — huge week. Your consistency is what's driving these results. Let's push compounds up 5kg and hold nutrition steady. Sleep looks great — keep protecting it."
                    />
                    <div className="mt-3 flex gap-2">
                        ...
                        <Button
                            size="sm"
                            className="ml-auto rounded-full bg-brand-gradient text-primary-foreground"
                        >
                            Send feedback
                        </Button>
                    </div>
...
function MetricCard({
    ...
    return (
        <Card className="border-border/60 bg-card p-5 shadow-card-premium">
            ...
            <div className="mt-3 text-xs tracking-wider text-muted-foreground uppercase">
                {label}
            </div>
