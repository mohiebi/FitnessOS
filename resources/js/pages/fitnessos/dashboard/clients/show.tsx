            ...
            <Tabs defaultValue="overview">
                ...
                <TabsContent value="overview" className="space-y-6">
                    <div className="grid gap-4 md:grid-cols-4">
                        {[
                            ...
                            <Card
                                key={s.l}
                                className="border-border/60 bg-card p-5 shadow-card-premium"
                            >
                        ...
                        <Card className="border-border/60 bg-card p-6 shadow-card-premium">
                            ...
                            <div className="mt-4 space-y-3">
                                {checkins.map((ck) => (
                                    ...
                                    >
                                        <div className="grid h-10 w-10 place-items-center rounded-lg bg-primary/10 font-mono text-sm text-primary">
                                            W{ck.week}
                                        </div>
                    ...
                    <Card className="border-border/60 bg-card p-6 shadow-card-premium">
                        ...
                        <dl className="mt-4 grid gap-4 md:grid-cols-2">
                            {[
                                ['Age', '28'],
                                ['Height', '168 cm'],
                                ['Starting weight', '92.4 kg'],
                                ['Target weight', '80 kg'],
                                ['Training experience', 'Intermediate'],
                                ['Injuries', 'Old L4/L5 strain'],
                                ['Sleep average', '7 hours'],
                                ['Occupation', 'Product designer, WFH'],
                            ].map(([k, v]) => (
                                <div key={k}>
                ...
                <TabsContent value="nutrition">
                    <Card className="border-border/60 bg-card p-6 shadow-card-premium">
                        <div className="mb-4 flex items-center gap-2">
                            ...
                            <h3 className="font-semibold">
                                Meal plan · 2,700 kcal / 220P 260C 80F
                            </h3>
                        </div>
                        <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
                            {meals.map((m) => (
                                ...
                                >
                                    ...
                                    <div className="mt-2 grid grid-cols-2 gap-4 text-sm md:grid-cols-4">
                                        ...
                                        <div>
                                            ...
                                            <div>{ck.energy}/10</div>
                                        </div>
                                        <div>
                                            <div className="text-xs text-muted-foreground">
                                                Adherence
                                            </div>
                                            <div>{ck.adherence}%</div>
                                        </div>
                                    </div>
                                </div>
                            ))}
                    ...
                    <Card className="border-border/60 bg-card p-6 shadow-card-premium">
                        <div className="space-y-3">
                            {messages.map((m, i) => (
                                ...
                                >
                                    <div
                                        className={`max-w-md rounded-2xl px-4 py-2 text-sm ${m.from === 'coach' ? 'bg-primary text-primary-foreground' : 'bg-secondary'}`}
                                    >
                                        {m.text}
                ...
                <TabsContent value="documents">
                    <EmptyState
                        icon={FileText}
                        title="No documents"
                        desc="Waivers and intake PDFs will appear here."
                    />
                </TabsContent>
                <TabsContent value="payments">
                    <Card className="border-border/60 bg-card p-6 shadow-card-premium">
                        ...
                        <div className="mt-4 space-y-2">
                            {[
                                ['Nov 1, 2026', '$199.00', 'Paid'],
                                ['Oct 1, 2026', '$199.00', 'Paid'],
                                ['Sep 1, 2026', '$199.00', 'Paid'],
                            ].map(([d, a, s]) => (
                                <div
                                    key={d}
