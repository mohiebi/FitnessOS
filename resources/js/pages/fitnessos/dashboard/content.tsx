            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                {posts.map((p) => {
                    ...
                    return (
                        <Card
                            key={p.title}
                            className="overflow-hidden border-border/60 bg-card shadow-card-premium transition hover:-translate-y-1 hover:shadow-glow"
                        >
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                    {[
                        ...
                        <Badge
                            key={t}
                            variant="outline"
                            className="cursor-pointer border-primary/30 bg-primary/10"
                        >
                            {t}
                        </Badge>
                    ))}
