                    ...
                    <Card className="border-border/60 bg-card p-6 shadow-card-premium">
                        ...
                        <div className="space-y-3">
                            {day.exercises.map((e, i) => (
                                <div
                                    key={i}
                                    className="group flex items-start gap-3 rounded-xl border border-border/60 bg-background p-4"
                                >
                                    <GripVertical className="mt-2 h-4 w-4 cursor-grab text-muted-foreground" />
                                    <div className="grid h-12 w-16 shrink-0 place-items-center rounded-lg bg-primary/10 text-primary">
                ...
                <Card className="h-fit border-border/60 bg-card p-4 shadow-card-premium">
                    ...
                    <div className="mt-3 space-y-1">
                        {exercises.map((ex) => (
                            <div
                                key={ex.name}
                                className="flex cursor-pointer items-center justify-between rounded-lg p-2 text-sm hover:bg-accent/10"
                            >
                                <div>
