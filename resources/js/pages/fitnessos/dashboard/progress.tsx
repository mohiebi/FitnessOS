...
function Progress() {
    return (
        <div>
            <PageHeader
                title="Progress"
                description="Sarah Chen — 12-week transformation snapshot."
            />

            <div className="grid gap-6 lg:grid-cols-2">
                <Chart title="Weight (kg)">
                ...
                <div className="grid grid-cols-2 gap-3 md:grid-cols-6">
                    {[47, 13, 44, 45, 33, 52].map((i, idx) => (
                        ...
                        >
                            ...
                            />
                            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-background/80 to-transparent p-2 text-xs">
                                Week {idx * 2 + 1}
                            </div>
                        </div>
                    ))}
